...
public class Shravan1
{
			...
			@QueryParam("responder") String responder)
	{
		...
		askFast.ask("Are you coming to my bday party at Rotterdam?", QuestionType.CLOSED, null);
	...
	@Consumes("*/*")
	public Response answerQuestion(String answer_json, @PathParam("id") String answerId,
			...
			@QueryParam("responder") String responder)
	{
		...
		{
			return askFast.redirect(getUrl() + "/questions/" + answerId, DialogSettings.HOST
																			+ "/questionanswer");
		}
